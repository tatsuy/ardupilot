...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Param: ZIGZAG_SP2_DELAY
    // @DisplayName: Zigzag spray stop delay
    // @Description: the delay for spray stop
    // @User: Standard
    AP_GROUPINFO("ZIGZAG_SP2_DELAY", 57, ParametersG2, zigzag_spray_stop_delay, 500),
    ...
    // @User: Standard
    AP_GROUPINFO("ZIGZAG_SPRAY", 60, ParametersG2, zigzag_spray, 7),
