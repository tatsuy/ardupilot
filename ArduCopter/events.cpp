...
void Copter::failsafe_radio_on_event()
{
    ...
    } else if (flightmode == &copter.mode_auto && failsafe_option(FailsafeOption::RC_CONTINUE_IF_AUTO)) {
...
void Copter::failsafe_gcs_on_event(void)
{
    ...
    } else if (flightmode == &copter.mode_auto && failsafe_option(FailsafeOption::GCS_CONTINUE_IF_AUTO)) {
        // Allow mission to continue when FS_OPTIONS is set to continue mission
...
void Copter::failsafe_terrain_on_event()
{
    ...
    } else if (flightmode == &copter.mode_rtl) {
