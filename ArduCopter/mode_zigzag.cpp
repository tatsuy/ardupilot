...
const AP_Param::GroupInfo ModeZigZag::var_info[] = {
    ...
    // @User: Standard
    AP_GROUPINFO_FLAGS("AUTO_ENABLE", 0, ModeZigZag, _enabled, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @Values: 0:Disabled,1:Enabled
    // @User: Advanced
    AP_GROUPINFO("SPRAYER", 1, ModeZigZag, _spray_enabled, ZIGZAG_SPRAY_ENABLED),
    ...
    // @Range: 1 127
    // @User: Advanced
    AP_GROUPINFO("WP_DELAY", 2, ModeZigZag, _wp_delay, ZIGZAG_WP_DELAY),
    ...
    // @Range: 0.1 100
    // @User: Advanced
    AP_GROUPINFO("SIDE_DIST", 3, ModeZigZag, _side_dist, 4),
    ...
    // @User: Advanced
    AP_GROUPINFO("DIRECTION", 4, ModeZigZag, _direction, 0),
    ...
    // @Range: -1 32767
    // @User: Advanced
    AP_GROUPINFO("LINE_NUM", 5, ModeZigZag, _line_num, 0),
        ...
        case MANUAL_REGAIN:
            ...
            if (calculate_next_dest(ab_dest, stage == AUTO, next_dest, terr_alt)) {
                ...
                if (wp_nav->set_wp_destination(next_dest, terr_alt)) {
                    ...
                    spray(true);
                    reach_wp_time_ms = 0;
                    if (auto_enabled == false || line_num == ZIGZAG_LINE_INFINITY) {
