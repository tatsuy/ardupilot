...
void Copter::arm_motors_check()
{
    ...
    if (yaw_in > 4000) {
        ...
        // arm the motors and configure for flight
        if (arming_counter == AUTO_TRIM_DELAY && motors->armed() && flightmode == &copter.mode_stabilize) {
...
void Copter::auto_disarm_check()
{
    ...
    if (!motors->armed() || disarm_delay_ms == 0 || flightmode == &copter.mode_throw) {
...
void Copter::motors_output()
{
    ...
    if (ap.in_arming_delay && (!motors->armed() || millis()-arm_time_ms > ARMING_DELAY_SEC*1.0e3f || flightmode == &copter.mode_throw)) {
