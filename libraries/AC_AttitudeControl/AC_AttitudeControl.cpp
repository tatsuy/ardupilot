...
void AC_AttitudeControl::set_forward_lateral(float target_forward, float target_lateral, float input_max)
{
    _motors.set_forward(target_forward / input_max);
    _motors.set_lateral(target_lateral / input_max);
}
