...
const AP_Param::GroupInfo RCMapper::var_info[] = {
    ...
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO_FRAME("FORWARD",    4, RCMapper, _ch_forward, 6, AP_PARAM_FRAME_SUB & AP_PARAM_FRAME_OMNI),
    ...
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO_FRAME("LATERAL",    5, RCMapper, _ch_lateral, 7, AP_PARAM_FRAME_SUB & AP_PARAM_FRAME_OMNI),
