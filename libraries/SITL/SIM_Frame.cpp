...
static Motor dof15_hexa_motors[] =
{
        // 13.06431342950827, 7.63074021243006
    Motor(AP_MOTORS_MOT_1,  90, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  2, 0, 0, 0, 0, -15, -15),
    Motor(AP_MOTORS_MOT_2, -90, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 5, 0, 0, 0, 0, -15, -15),
    Motor(AP_MOTORS_MOT_3, -30, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  6, 0, -13.06431342950827, -13.06431342950827, 0,  7.63074021243006,  7.63074021243006), // 28.4, 14
    Motor(AP_MOTORS_MOT_4, 150, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 3, 0, -13.06431342950827, -13.06431342950827, 0,  7.63074021243006,  7.63074021243006), // 28.4, 14
    Motor(AP_MOTORS_MOT_5,  30, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 1, 0,  13.06431342950827,  13.06431342950827, 0,  7.63074021243006,  7.63074021243006), // 28.4, 14
    Motor(AP_MOTORS_MOT_6,-150, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  4, 0,  13.06431342950827,  13.06431342950827, 0,  7.63074021243006,  7.63074021243006)  // 28.4, 14
};

static Motor dof30_hexa_motors[] =
{

    Motor(AP_MOTORS_MOT_1,  90, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  2, 0, 0, 0, 0, -30, -30),
    Motor(AP_MOTORS_MOT_2, -90, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 5, 0, 0, 0, 0, -30, -30),
    Motor(AP_MOTORS_MOT_3, -30, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  6, 0, -26.56505117707799, -26.56505117707799, 0,  16.10211375198601,  16.10211375198601),
    Motor(AP_MOTORS_MOT_4, 150, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 3, 0, -26.56505117707799, -26.56505117707799, 0,  16.10211375198601,  16.10211375198601),
    Motor(AP_MOTORS_MOT_5,  30, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 1, 0,  26.56505117707799,  26.56505117707799, 0,  16.10211375198601,  16.10211375198601),
    Motor(AP_MOTORS_MOT_6,-150, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  4, 0,  26.56505117707799,  26.56505117707799, 0,  16.10211375198601,  16.10211375198601)
};

static Motor dof35_hexa_motors[] =
{
    Motor(AP_MOTORS_MOT_1,  90, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  2, 0, 0, 0, 0, -35, -35),
    Motor(AP_MOTORS_MOT_2, -90, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 5, 0, 0, 0, 0, -35, -35),
    Motor(AP_MOTORS_MOT_3, -30, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  6, 0, -31.232518541469965, -31.232518541469965, 0,  19.29534273533122,  19.29534273533122), // 28.4, 14
    Motor(AP_MOTORS_MOT_4, 150, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 3, 0, -31.232518541469965, -31.232518541469965, 0,  19.29534273533122,  19.29534273533122), // 28.4, 14
    Motor(AP_MOTORS_MOT_5,  30, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 1, 0,  31.232518541469965,  31.232518541469965, 0,  19.29534273533122,  19.29534273533122), // 28.4, 14
    Motor(AP_MOTORS_MOT_6,-150, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  4, 0,  31.232518541469965,  31.232518541469965, 0,  19.29534273533122,  19.29534273533122)  // 28.4, 14
};

static Motor dof45_hexa_motors[] =
{
    Motor(AP_MOTORS_MOT_1,  90, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  2, 0, 0, 0, 0, -45,   -45),
    Motor(AP_MOTORS_MOT_2, -90, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 5, 0, 0, 0, 0, -45,   -45),
    Motor(AP_MOTORS_MOT_3, -30, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  6, 0, -40.8933946491309, -40.8933946491309, 0,  26.56505117707799,  26.56505117707799),
    Motor(AP_MOTORS_MOT_4, 150, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 3, 0, -40.8933946491309, -40.8933946491309, 0,  26.56505117707799,  26.56505117707799),
    Motor(AP_MOTORS_MOT_5,  30, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 1, 0,  40.8933946491309,  40.8933946491309, 0,  26.56505117707799,  26.56505117707799),
    Motor(AP_MOTORS_MOT_6,-150, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  4, 0,  40.8933946491309,  40.8933946491309, 0,  26.56505117707799,  26.56505117707799)
};

static Motor dof30_octa_motors[] =
{
    Motor(AP_MOTORS_MOT_1,   22.5, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 1, 0, -28.075554210280885, -28.075554210280885, 0, -12.45891019169079, -12.45891019169079),
    Motor(AP_MOTORS_MOT_2, -157.5, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  5, 0, -28.075554210280885, -28.075554210280885, 0, 12.45891019169079, 12.45891019169079),
    Motor(AP_MOTORS_MOT_3,  67.5, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 2, 0, 12.45891019169079, 12.45891019169079, 0, 28.075554210280885, 28.075554210280885),
    Motor(AP_MOTORS_MOT_4,  157.5, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  4, 0, 28.075554210280885, 28.075554210280885, 0, 12.45891019169079, 12.45891019169079),
    Motor(AP_MOTORS_MOT_5,  -22.5, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 8, 0, 28.075554210280885, 28.075554210280885, 0, -12.45891019169079, -12.45891019169079),
    Motor(AP_MOTORS_MOT_6, -112.5, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  6, 0, 12.45891019169079, 12.45891019169079, 0, -28.075554210280885, -28.075554210280885),
    Motor(AP_MOTORS_MOT_7,  -67.5, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 7, 0, -12.45891019169079, -12.45891019169079, 0, 28.075554210280885, 28.075554210280885),
    Motor(AP_MOTORS_MOT_8,  112.5, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  3, 0, -12.45891019169079, -12.45891019169079, 0, -28.075554210280885, -28.075554210280885),
};
...
static Frame supported_frames[] =
{
    ...
    Frame("dof15-hexa",  6, dof15_hexa_motors),
    Frame("dof30-hexa",  6, dof30_hexa_motors),
    Frame("dof35-hexa",  6, dof35_hexa_motors),
    Frame("dof45-hexa",  6, dof45_hexa_motors),
    Frame("dof30-octa",  8, dof30_octa_motors)
};
